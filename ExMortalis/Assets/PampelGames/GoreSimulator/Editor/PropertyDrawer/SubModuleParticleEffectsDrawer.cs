...
namespace PampelGames.GoreSimulator.Editor
{
    ...
    public class SubModuleParticleEffectsDrawer : PropertyDrawer
    {
        ...
        private VisualElement MakeItem()
        {
            ...
            rotation.tooltip = "Rotation of the GameObject (Z+ is forward).";

            setParent.tooltip = "Sets the parent of the GameObject after spawning. If Both is selected, two GameObjects will be instantiated.";
